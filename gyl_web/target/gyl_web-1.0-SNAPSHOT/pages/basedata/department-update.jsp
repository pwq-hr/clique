    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a
                        href="${pageContext.request.contextPath}/department/findAll">部门</a></li>
                <li class="active">部门修改</li>
            </ol>
        </section>
        <!-- 内容头部 /-->

        <form action="${pageContext.request.contextPath}/department/updateById" method="post">
            <!-- 正文区域 -->
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="name"
                                   placeholder="" value="${department.name}">
                        </div>
                        <div class="col-md-2 title">部门描述</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="desc"
                                   placeholder="" value="${department.desc}">
                        </div>
