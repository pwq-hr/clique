        ...
        <form id="form" method="post">
            <section class="content">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">填写销售发货单信息进行添加</div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#save_button").click(function () {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/xsfhd/saveZhubAndZib",
                type: "post",
                data: params,
                dataType: "json",
                async: false,
                success: function (data) {
                    ...
                    if(resFlag == "1"){ //成功
                        alert("添加成功!");
                        window.location.href = "${pageContext.request.contextPath}/xsfhd/getDdhToAddUI";
                    }else { //失败
                        alert("添加失败:"+msgList);
                        $.ajax({
                            url: "${pageContext.request.contextPath}/xsfhd/getDdh",
                            type: "get",
                            data: {},
                            dataType: "text",
                            async: false,
        ...
        $("#toquery_button").click(function () {
            window.location.href = "${pageContext.request.contextPath}/pages/business/xsfhd-query.jsp";
        });
    });
    ...
    function add_zib(x) {
        ...
        if (flag == "1") {
            ...
            var str = '<tr id="' + nowCount + '">' +
                ...
                '                                </button>' +
                '</td>' +
                '<td>                            <input id="hh-' + nowCount + '" type="text" readonly="readonly"  class="form-control" name="xsfhd_zibs[' + nowCount + '].hh"\n' +
                '                                   placeholder="行号" value="' + nowCount + '"></td>\n' +
                '<td>                            <input id="fhrq-' + nowCount + '" type="text" class="form-control dateTimePicker" name="xsfhd_zibs[' + nowCount + '].fhrq"\n' +
                '                                   placeholder="yyyy-MM-dd hh:mm" value=""></td>\n' +
                '<td>                            <input id="spbm-' + nowCount + '" type="text" class="form-control" name="xsfhd_zibs[' + nowCount + '].spbm"\n' +
                '                                   placeholder="存货编码(不为空)"></td>\n' +
                '<td>                            <input id="spmc-' + nowCount + '" type="text" class="form-control" name="xsfhd_zibs[' + nowCount + '].spmc"\n' +
                '                                   placeholder="存货名称" value=""></td>\n' +
                '<td>                            <input id="type-' + nowCount + '" type="text" class="form-control" name="xsfhd_zibs[' + nowCount + '].type"\n' +
                '                                   placeholder="型号" value=""></td>\n' +
                '<td>                            <input id="dw-' + nowCount + '" type="text" class="form-control" name="xsfhd_zibs[' + nowCount + '].dw"\n' +
                '                                   placeholder="计量单位" value=""></td>\n' +
                '<td>                            <input id="scrq-' + nowCount + '" type="text" class="form-control" name="xsfhd_zibs[' + nowCount + '].scrq"\n' +
                '                                   placeholder="生产日期" value=""></td >\n' +
                '<td>                            <input id="sxrq-' + nowCount + '" type="text" class="form-control" name="xsfhd_zibs[' + nowCount + '].sxrq"\n' +
                '                                   placeholder="失效日期" value=""></td >\n' +
                '<td>                            <input id="yfsl-' + nowCount + '" type="text" class="form-control" name="xsfhd_zibs[' + nowCount + '].yfsl"\n' +
                '                                   placeholder="应发数量" value=""></td>\n' +
                '<td>                            <input id="sfsl-' + nowCount + '" type="text" class="form-control" name="xsfhd_zibs[' + nowCount + '].sfsl"\n' +
                '                                   placeholder="实发数量" value=""></td>\n' +
                '<td>                            <input id="dj-' + nowCount + '" type="text" class="form-control" name="xsfhd_zibs[' + nowCount + '].dj"\n' +
                '                                   placeholder="单价" value=""></td>\n' +
                '<td>                            <input id="je-' + nowCount + '" type="text" class="form-control" name="xsfhd_zibs[' + nowCount + '].je"\n' +
                '                                   placeholder="金额" value=""></td>\n' +
                '<td>                            <select id="zp-' + nowCount + '" type="text" class="form-control" name="xsfhd_zibs[' + nowCount + '].zp">\n' +
                '                                   <option value="1">是</option>' +
                '                                   <option selected="selected" value="0">否</option>' +
                '                                </select></td>\n' +
                '<td>                            <input id="ytdjh-' + nowCount + '" type="text" class="form-control" name="xsfhd_zibs[' + nowCount + '].ytdjh" ' +
                '                                   placeholder="源头单据号" value=""></td>\n' +
                '<td>                            <input id="ythh-' + nowCount + '" type="text" class="form-control" name="xsfhd_zibs[' + nowCount + '].ythh"\n' +
                '                                   placeholder="源头行号" value=""></td>\n' +
                '<td>                            <input id="lydjh-' + nowCount + '" type="text" class="form-control" name="xsfhd_zibs[' + nowCount + '].lydjh"\n' +
                '                                   placeholder="来源单据号" value=""></td>\n' +
                '<td>                            <input id="lyhh-' + nowCount + '" type="text" class="form-control" name="xsfhd_zibs[' + nowCount + '].lyhh"\n' +
                '                                   placeholder="来源行号" value=""></td>\n' +
                '<td>                            <input readonly="readonly" id="ljfhsl-' + nowCount + '" type="text" class="form-control" name="xsfhd_zibs[' + nowCount + '].ljfhsl" ' +
                '                                   placeholder="累计发货数量" value="0"></td>\n' +
                '<td>                            <select id="sfckjs-' + nowCount + '" type="text" class="form-control" name="xsfhd_zibs[' + nowCount + '].sfckjs">\n' +
                '                                   <option selected="selected" value="0">未结束</option>' +
                '                                </select></td>\n' +
                '<td>                            <select id="status-' + nowCount + '" type="text" class="form-control" name="xsfhd_zibs[' + nowCount + '].status">\n' +
                '                                   <option selected="selected" value="0">未结束</option>' +
                '                                </select></td>\n' +
                '</tr>';
