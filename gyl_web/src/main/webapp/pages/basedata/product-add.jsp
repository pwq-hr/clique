    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a
                        href="${pageContext.request.contextPath}/product/findAll">商品档案</a></li>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-1 data">
                            <input type="text" class="form-control" placeholder="单位" value="" name="unit">
                        </div>
                        ...
                        <div class="col-md-1 data">
                            <input type="text" class="form-control" placeholder="税率" value="" name="rate">
                        </div>
                        <div class="col-md-3 title"></div>
                        <%--7--%>
