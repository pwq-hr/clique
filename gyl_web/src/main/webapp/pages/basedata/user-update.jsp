                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="username"
                                   placeholder="名称" value="${user.username}">
                        </div>
                        <%--2--%>
                        <div class="col-md-2 title">用户密码</div>
                        <div class="col-md-4 data">
                            <input type="password" value="${user.password}" class="form-control" placeholder="密码" value="" name="password">
                        </div>
                        <%--3--%>
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="电话" value="${user.phone}" name="phone">
                        </div>
                        <%--5--%>
                        <div class="col-md-2 title">邮箱</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="邮箱" value="${user.email}" name="email">
                        </div>
                        <%--6--%>
