    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a
                        href="${pageContext.request.contextPath}/product/findAll">商品</a></li>
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="num"
                                   placeholder="编码" value="${product.num}">
                        </div>
                        <%--3--%>
                        <div class="col-md-2 title">商品型号</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="type"
                                   placeholder="型号" value="${product.type}">
                        </div>
                        <%--4--%>
                        <div class="col-md-2 title">商品单位</div>
                        <div class="col-md-1 data">
                            <input type="text" class="form-control" placeholder="单位" value="${product.unit}" name="unit">
                        </div>
                        ...
                        <%--6--%>
                        <div class="col-md-2 title">商品税率</div>
                        <div class="col-md-1 data">
                            <input type="text" class="form-control" placeholder="税率" value="${product.rate}" name="rate">
                        </div>
                        <div class="col-md-3 title"></div>
                        <%--7--%>
                        ...
                        <div class="col-md-10 data">
                            <input type="text" class="form-control" name="desc"
                                   placeholder="描述" value="${product.desc}">
                        </div>
                    </div>
                </div>
                <!--订单信息/--> <!--工具栏-->
