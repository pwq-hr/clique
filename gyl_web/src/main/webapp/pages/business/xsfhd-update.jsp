            ...
            <section class="content">
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        <div class="col-md-2 title">发货号</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="ddh"
                                   placeholder="发货号" value="">
                        </div>
                        <div class="col-md-2 title">发货日期</div>
                        <div class="col-md-4 data">
                            <div class="input-group date">
                                <div class="input-group-addon">
                                    <i class="fa fa-calendar"></i>
                                </div>
                                <input type="text" class="form-control pull-right dateTimePicker" name="fhrq">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 data">
                            <select class="form-control" name="sfckjs">
                                <option value="0">否</option>
                            </select>
                        </div>
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title">添加销售发货单子单</h4>
                                    </div>
                                            ...
                                            <div class="form-horizontal">
                                                ...
                                                <form id="zib_save_form" method="post">
                                                    ...
                                                    <section class="content"> <!--产品信息-->
                                                        ...
                                                        <div class="panel panel-default">
                                                            <div class="panel-heading">销售发货单子单</div>
                                                            <div class="row data-type">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#query").click(function () {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/xsfhd/findAllAndSfspIsZero",
                type: "post",
                data: params,
                dataType: "json",
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < xsfhd_zhubs.length; i++) {
                        html += '<tr>\n' +
                            ...
                            '<button id="zhub_xg_btn" i=' + i + ' onclick="zhub_xg_btn(this)" zhubId="' + xsfhd_zhubs[i].xsfhd_zhub_id + '" type="button" data-toggle="modal" data-target="#myModal-zhub-' + i + '" class="btn bg-olive btn-xs"\n' +
                            '">\n' +
                            '    修改\n' +
                            '</button>\n' +
                            <%--模拟窗口--%>
                            ...
                            '\n' +
                            '                                                        <div class="panel panel-default">\n' +
                            '                                                            <div class="panel-heading">修改销售发货单主单</div>\n' +
                            '                                                            <div class="row data-type">\n' +
                            '\n' +                                                           /* 此处是 标记一个主表的id属性，方便根据id更新主表zhub*/
                            '                                                                <input id="zhub_xg_xsfhd_zhub_id-' + i + '" type="hidden" name="xsfhd_zhub_id" value="">\n' +
                            '                                                                \n' +
                            '                                                                <div class="col-md-2 title">发货号</div>\n' +
                            '                                                                <div class="col-md-4 data">\n' +
                            ...
                            '                                                                            <i class="fa fa-calendar"></i>\n' +
                            '                                                                        </div>\n' +
                            '                                                                        <input id="zhub_xg_fhrq-' + i + '" type="text"\n' +
                            '                                                                               class="form-control pull-right dateTimePicker"\n' +
                            '                                                                               name="fhrq">\n' +
                            '                                                                    </div>\n' +
                            '                                                                </div>\n' +
                            ...
                            '                                                                <div class="col-md-4 data">\n' +
                            '                                                                    <select class="form-control" name="sfckjs">\n' +
                            '                                                                        <option id="zhub_xg_sfckjs0_option-' + i + '" value="0">否</option>\n' +
                            '                                                                    </select>\n' +
                            '                                                                </div>\n' +
                            '                                                                <div class="col-md-2 title">状态</div>\n' +
                            '                                                                <div class="col-md-4 data">\n' +
                            ...
                            '                                    </div>\n' +
                            '                                    <div class="modal-footer">\n' +
                            '                                        <button i="' + i + '" onclick="updateXsfhd_zhubById(this)" type="button" class="btn btn-outline" data-dismiss="modal">修改</button>\n' +
                            '                                        <button type="button" class="btn btn-outline" data-dismiss="modal">取消</button>\n' +
                            '                                    </div>\n' +
                            '                                </div>\n' +
                            '                                <!-- /.modal-content -->\n' +
                            ...
                            '                        </div>' +
                            <%--模拟窗口/--%>
                            '<button zhubId="' + xsfhd_zhubs[i].xsfhd_zhub_id + '" data-toggle="modal" data-target="#myModal_2" type="button" class="btn bg-olive btn-xs"\n' +
        ...
        $("#get_zhub_ddh").click(function () {
            $.ajax({
                url: "${pageContext.request.contextPath}/xsfhd/getZhub_ddh",
                type: "get",
                data: {},
                dataType: "text",
                async: false,
        ...
        $("#zhub_save").click(function () {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/xsfhd/saveXsfhd_zhub",
                type: "post",
                data: params,
                dataType: "text",
                //async: false,
        ...
        $("#get_zib_hh").click(function () {
            ...
            if (zhub_id == -1) {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/xsfhd/getZib_hh",
                    type: "get",
                    data: {"xsfhd_zhub_id": zhub_id},
                    dataType: "text",
                    async: false,
                    success: function (data) {
                        var hh = data;
        ...
        $("#zib_save").click(function () {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/xsfhd/saveZib",
                type: "post",
                data: params,
                dataType: "text",
                //async: false,
    ...
    function zhub_xg_btn(x) {
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/xsfhd/findXsfhd_zhubById",
            type: "get",
            ...
            success: function (data) {
                ...
                var i = $(x).attr("i");
                //2,给每一个按钮框添加值
                $("#zhub_xg_xsfhd_zhub_id-" + i).attr("value", xsfhd_zhub.xsfhd_zhub_id);
                $("#zhub_xg_ddh-" + i).attr("value", xsfhd_zhub.ddh);
                $("#zhub_xg_fhrq-" + i).attr("value", xsfhd_zhub.fhrqStr);
                $("#zhub_xg_ck-" + i).attr("value", xsfhd_zhub.ck);
                $("#zhub_xg_kgy-" + i).attr("value", xsfhd_zhub.kgy);
                $("#zhub_xg_bm-" + i).attr("value", xsfhd_zhub.bm);
                $("#zhub_xg_kh-" + i).attr("value", xsfhd_zhub.kh);
                $("#zhub_xg_zdr-" + i).attr("value", xsfhd_zhub.zdr);
                $("#zhub_xg_zdsj-" + i).attr("value", xsfhd_zhub.zdsjStr);
                $("#zhub_xg_spr-" + i).attr("value", xsfhd_zhub.spr);
                $("#zhub_xg_spsj-" + i).attr("value", xsfhd_zhub.spsjStr);
                $("#zhub_xg_xgr-" + i).attr("value", xsfhd_zhub.xgr);
                $("#zhub_xg_xgsj-" + i).attr("value", xsfhd_zhub.xgsjStr);
    ...
    function updateXsfhd_zhubById(x) {
        //获取点击了该修改按钮所在的行号i
        var i = $(x).attr("i");
        //一定要移除disabled属性 ???????
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/xsfhd/updateXsfhd_zhubById",
            type: "post",
            data: params,
            dataType: "text",
            async: false,
    ...
    function delete_zhub(x) {
        ...
        if (confirm(msg) == true) {
            var xsfhd_zhub_id = $(x).attr("zhubId");
            $.ajax({
                url: "${pageContext.request.contextPath}/xsfhd/deleteXsfhd_ZhubById",
                type: "GET",
                data: {"xsfhd_zhub_id": xsfhd_zhub_id},
                dataType: "text",
                async: false,
    ...
    function deleteZhubByIds(x) {
        ...
        if (confirm(msg) == true) {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/xsfhd/deleteXsfhd_ZhubByIds",
                type: "GET",
                data: {"ids": ids},
                dataType: "text",
                async: false,
            ...
            success: function (data) {
                ...
                for (var i = 0; i < xsfhd_zibs.length; i++) {
                    html += '<tr>\n' +
                        ...
                        '<td class="text-center">\n' +
                        '<button id="zib_xg_btn-'+i+'" status="'+xsfhd_zibs[i].status+'" i="' + i + '" zibId="' + xsfhd_zibs[i].xsfhd_zib_id + '" onclick="zib_xg_btn(this)" type="button" data-toggle="modal" data-target="#myModal-zib-' + i + '" class="btn bg-olive btn-xs"\n' +
                        '    >\n' +
                        '    修改\n' +
                        '</button>\n' +
                        <%--模拟窗口--%>
                        ...
                        '                                                            <div class="row data-type">\n' +
                        '                        <input id="zib_xg_xsfhd_zhub_id-' + i + '" type="hidden" name="xsfhd_zhub_id" value="">\n' + /*主表id--》外键*/
                        '                        <input id="zib_xg_xsfhd_zib_id-' + i + '" type="hidden" name="xsfhd_zib_id" value="">\n' + /*子表id*/
                        '                        <div class="col-md-2 title">行号</div>\n' +
                        '                        <div class="col-md-4 data">\n' +
                        ...
                        '                                            <i class="fa fa-calendar"></i>\n' +
                        '                                </div>\n' +
                        '                                <input id="zib_xg_fhrq-' + i + '" type="text"\n' +
                        '                                      class="form-control pull-right dateTimePicker" name="fhrq">\n' +
                        '                             </div>\n' +
                        '                         </div>\n' +
                        '                        <div class="col-md-2 title">存货编码</div>\n' +
                        '                        <div class="col-md-4 data">\n' +
                        ...
                        '                         <div class="col-md-2 title">是否出库结束</div>\n' +
                        '                         <div class="col-md-4 data">\n' +
                        '                             <select id="zib_xg_select_sfckjs-' + i + '" class="form-control" name="sfckjs">\n' +
                        '                                    <option id="zib_xg_sfckjs0_option-' + i + '" value="0">未结束</option>\n' +
                        '                             </select>\n' +
                        '                          </div>\n' +
                        '                         <div class="col-md-2 title">状态</div>\n' +
                        '                         <div class="col-md-4 data">\n' +
                        ...
                        '                                    </div>\n' +
                        '                                    <div class="modal-footer">\n' +
                        '                                        <button zibId="' + xsfhd_zibs[i].xsdd_zib_id + '" i="' + i + '" onclick="updateZibById(this)" type="button" class="btn btn-outline" data-dismiss="modal">修改</button>\n' +
                        '                                        <button type="button" class="btn btn-outline" data-dismiss="modal">取消</button>\n' +
                        '                                    </div>\n' +
                        '                                </div>\n' +
                        '                                <!-- /.modal-content -->\n' +
                        ...
                        '                        </div>' +
                        <%--模拟窗口/--%>
                        '<button zibId="' + xsfhd_zibs[i].xsfhd_zib_id + '" type="button" class="btn bg-olive btn-xs"\n' +
    ...
    function zib_xg_btn(x) {
        ...
        if(zib_status == 1){
            ...
            //没有结束
            var xsfhd_zib_id = $(x).attr("zibId");
            $.ajax({
                url: "${pageContext.request.contextPath}/xsfhd/findXsfhd_zibById",
                type: "get",
                data: {"xsfhd_zib_id": xsfhd_zib_id},
                dataType: "json",
                async: false,
                success: function (data) {
                    var xsfhd_zib = data;
                    //添加数据到模态框中
                    //2,给每一个按钮框添加值
                    $("#zib_xg_xsfhd_zhub_id-" + i).attr("value", xsfhd_zib.xsfhd_zhub_id); /*主表d --》外键*/
                    $("#zib_xg_xsfhd_zib_id-" + i).attr("value", xsfhd_zib.xsfhd_zib_id);/*子表id*/
                    $("#zib_xg_hh-" + i).attr("value", xsfhd_zib.hh);
                    $("#zib_xg_fhrq-" + i).attr("value", xsfhd_zib.fhrqStr);
                    $("#zib_xg_spbm-" + i).attr("value", xsfhd_zib.spbm);
                    $("#zib_xg_spmc-" + i).attr("value", xsfhd_zib.spmc);
                    $("#zib_xg_type-" + i).attr("value", xsfhd_zib.type);
                    $("#zib_xg_dw-" + i).attr("value", xsfhd_zib.dw);
                    $("#zib_xg_scrq-" + i).attr("value", xsfhd_zib.scrqStr);
                    $("#zib_xg_sxrq-" + i).attr("value", xsfhd_zib.sxrqStr);
                    $("#zib_xg_yfsl-" + i).attr("value", xsfhd_zib.yfsl);
                    $("#zib_xg_sfsl-" + i).attr("value", xsfhd_zib.sfsl);
                    $("#zib_xg_dj-" + i).attr("value", xsfhd_zib.dj);
                    $("#zib_xg_je-" + i).attr("value", xsfhd_zib.je);
                    /*zp*/
                    if (xsfhd_zib.zp == 1) {
                    ...
                    $("#zib_xg_ytdjh-" + i).attr("value", xsfhd_zib.ytdjh);
                    $("#zib_xg_ythh-" + i).attr("value", xsfhd_zib.ythh);
                    $("#zib_xg_lydjh-" + i).attr("value", xsfhd_zib.lydjh);
                    $("#zib_xg_lyhh-" + i).attr("value", xsfhd_zib.lyhh);
                    $("#zib_xg_ljfhsl-" + i).attr("value", xsfhd_zib.ljfhsl);
                    $("#zib_xg_yfwcksl-" + i).attr("value", xsfhd_zib.yfwcksl);
                    $("#zib_xg_ljfhsl-" + i).attr("value", xsfhd_zib.ljfhsl);
    ...
    function updateZibById(x) {
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/xsfhd/updateXsfhd_zibById",
            type: "post",
            data: params,
            dataType: "text",
            // async: false,
    ...
    function delete_zib(x) {
        ...
        if (confirm(msg) == true) {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/xsfhd/deleteXsfhd_ZibById",
                type: "GET",
                data: {"xsfhd_zib_id": zibId},
                dataType: "text",
                async: false,
                success: function (data) {
                    alert("删除成功!")
    ...
    function deleteZibByIds(x) {
        ...
        if(confirm(msg) == true){
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/xsfhd/deleteXsfhd_ZibByIds",
                type: "GET",
                data: {"ids": ids},
                dataType: "text",
                async: false,
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < xsfhd_zibs.length; i++) {
                        html += '<tr>\n' +
                            ...
                            '                        </div>' +
                            <%--模拟窗口/--%>
                            '<button zibId="' + xsfhd_zibs[i].xsdd_zib_id + '" type="button" class="btn bg-olive btn-xs"\n' +
                            '    onclick="delete_zib(this)">\n' +
                            '    删除\n' +
                            '</button>\n' +
                            '</td>\n' +
