 ...
 *
 */
public class Cgygdzhib implements Serializable{
	...
	public Cgygdzhub getCgqgdzhub() {
		return cgqgdzhub;
	}

	public void setCgqgdzhub(Cgygdzhub cgqgdzhub) {
